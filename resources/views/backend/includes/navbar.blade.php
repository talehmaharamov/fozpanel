    ...
    <header class="header navbar navbar-expand-sm">
        ...
        <ul class="navbar-nav theme-brand flex-row  text-center">
            <li class="nav-item theme-text">
                <a href="{{ route('backend.index',locale()) }}" class="nav-link"> TechFOZ </a>
            </li>
        ...
        <ul class="navbar-item flex-row navbar-dropdown">
                ...
                <div class="dropdown  custom-dropdown-icon">
                    <a class="dropdown-toggle btn" href="#" role="button" id="langDropdown" data-toggle="dropdown"
                       aria-haspopup="true" aria-expanded="false"><img
                            src="" class="flag-width"
                            alt="flag"><span>{{trans(App::currentLocale())}}</span>
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none"
                             stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
                             class="feather feather-chevron-down">
                            <polyline points="6 9 12 15 18 9"></polyline>
                    ...
                    <div class="dropdown-menu dropdown-menu-right" aria-labelledby="langDropdown">
                        <a class="dropdown-item" data-img-value="az" data-value="English"
                           href="{{ route(Route::currentRouteName(),'az') }}"><img
                                src="{{asset('backend/assets/img/flags/az.svg')}}"
                                class="flag-width" alt="flag">
                            Azərbaycan</a>
                        <a class="dropdown-item" data-img-value="en" data-value="English"
                           href="{{ route(Route::currentRouteName(),'en') }}"><img
                                src="{{asset('backend/assets/img/flags/en.png')}}"
                                class="flag-width" alt="flag">
                            English </a>
                        <a class="dropdown-item" data-img-value="ru" data-value="Русский"
                           href="{{ route(Route::currentRouteName(),'ru') }}"><img
            ...
            <li class="nav-item dropdown user-profile-dropdown  order-lg-0 order-1">
                ...
                <div class="dropdown-menu position-absolute" aria-labelledby="userProfileDropdown">
                    ...
                    <div class="dropdown-item">
                        <form action="{{ route('logout',locale()) }}" method="post" id="formLogout">
                            @csrf
