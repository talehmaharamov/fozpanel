        ...
        <div class="form-form-wrap">
            <div class="form-container">
                <div class="form-content">
                    ...
                    <h1 class="">{{ trans('login') }}</h1>

                    <form class="text-left" method="POST" action="{{ route('login',locale()) }}">
                        @csrf
                        <div class="form">
                            ...
                            <div id="username-field" class="field-wrapper input">
                                ...
                                <input type="email" id="username" name="email" type="text" class="form-control"
                            ...
                            <div class="d-sm-flex justify-content-between">
                                <div class="field-wrapper">
                                    <button type="submit" class="btn btn-primary" value="">{{ trans('login') }}</button>
                                </div>
                            </div>
